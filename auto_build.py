    ...
    def main(need_debug_console: bool = False, need_compress: bool = False) -> None:
        ...
        options = argparse.Namespace(
            ...
            add_data=[
                ...
                ["plugins/preinstall_toolbox/src:plugins/preinstall_toolbox/src"],
                ["plugins/preinstall_toolbox/pyproject.toml:plugins/preinstall_toolbox/"],
                ["plugins/preinstall_toolbox/README.md:plugins/preinstall_toolbox/"],
                ["plugins/preinstall_toolbox/CHANGELOG.md:plugins/preinstall_toolbox/"],
            ],
            add_binary=[],
            hidden_import=[],
            uac_admin=False,
